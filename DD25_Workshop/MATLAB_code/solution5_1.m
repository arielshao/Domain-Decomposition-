...
% The Krylov accelerated version is faster than the parallel Schwarz method

% The Krylov version refers to the use of the Generalized Minimal Residual
% Method (gmres in MATLAB)
