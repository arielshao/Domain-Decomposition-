function [cpx, cpy, dist, bdy] = cpAnnulus2(x, y, R1, R2, cen)
...
%     bdy = 0
  ...
  % TODO: having non-strict inequalities here seems crucial: must write something about this...
  bdy1 = dist1 <= 0;
  bdy2 = dist2 >= 0;
  ...
  cpx(I) = x(I);
  cpy(I) = y(I);
  dist = zeros(size(dist1));
  dist(bdy1) = abs(dist1(bdy1));
  dist(bdy2) = abs(dist2(bdy2));
