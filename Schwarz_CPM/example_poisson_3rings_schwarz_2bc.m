...
% solve the Poisson equation -\Delta u=f on three mutually overlapping rings
...
% We apply such interior bc on both sides
...
% condtion
ghost_Gamma_1=(~(ring1) & ~ring2 & ~ring3 & band1);
ghost_Gamma_2=(~(ring2) & ~ring3 & ~ring1 & band2);
ghost_Gamma_3=(~(ring3) & ~ring1 & ~ring2 & band3);

% The following ghost points are used to apply the interior dirichlet
% boundary conditions
ghost_12=(~(ring1) & ring2 & band1);
ghost_13=(~(ring1) & ring3 & band1);

ghost_21=(~(ring2) & ring1 & band2);
ghost_23=(~(ring2) & ring3 & band2);

ghost_31=(~(ring3) & ring1 & band3);
ghost_32=(~(ring3) & ring2 & band3);
...
E13_bar=interp2_matrix(x1d,y1d,cpbar_x1(ghost_13),cpbar_y1(ghost_13),p);
...
%  M_ghost_13=(I(ghost_13,:)+E13_bar)/2;
...
E_ghost_13=interp2_matrix(x1d, y1d, cp_x1(ghost_13),cp_y1(ghost_13),1);
...
%     f_1(ghost_13)=E_ghost_13*u3;
   f_1(ghost_12)=u2(ghost_12);
    f_1(ghost_13)=u3(ghost_13);
