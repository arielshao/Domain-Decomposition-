...
% The optimized Schwarz method converges much faster than then classical Schwarz
% method.

% It takes 114 iterations for the classical Schwarz method to converge to the exact solution with the
% smallest possible error = 3.5e-14.

% It takes 17 iterations for the Optimized Schwarz method to converge to the exact solution with the
% smallest possible error = 4.7e-14.
