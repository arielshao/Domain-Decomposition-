...
% The Neumann-Neumann method diverges when a=2 or a=19. 
% The contraction factor |rho|>1 for a=2.

% If a=3 or a=18, it converges extremely slow; eg. it takes more than 300
